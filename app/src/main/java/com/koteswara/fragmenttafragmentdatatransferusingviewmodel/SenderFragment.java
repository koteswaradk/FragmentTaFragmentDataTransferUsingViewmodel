...
public class SenderFragment extends Fragment {
    ...
    FragmentToFragmentViewModel viewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel=new ViewModelProvider(getActivity()).get(FragmentToFragmentViewModel.class);
        view.findViewById(R.id.senddata).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container1,new ReceiverFragment()).commit();
                viewModel.setItem("data setted from the Frogmant");
            }
        });
    }
}